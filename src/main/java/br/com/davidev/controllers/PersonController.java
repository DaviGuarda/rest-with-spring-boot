package br.com.davidev.controllers;
...
import br.com.davidev.services.PersonServices;
import br.com.davidev.util.MediaType;
...
public class PersonController {
    ...
    @GetMapping(value = "/{id}",
            produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
                    MediaType.APPLICATION_YML})
    @Operation(summary = "Finds a Person", description = "Finds a People.",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Sucess", responseCode = "200",
